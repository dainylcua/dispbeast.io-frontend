...
const Sidebar = (props) => {
    return(
        ...
        <nav className="bg-gray-900 h-screen w-1/6 text-purple-400 text-2xl flex flex-col overflow-y-auto items-center justify-center font-medium sticky top-0 float-left z-0">
